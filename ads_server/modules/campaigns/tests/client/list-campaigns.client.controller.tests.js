(function () {
  ...
  describe('Campaigns List Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _CampaignsService_) {
      ...
      // Initialize the Campaigns List controller.
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all Campaigns', inject(function (CampaignsService) {
        // Set POST response
